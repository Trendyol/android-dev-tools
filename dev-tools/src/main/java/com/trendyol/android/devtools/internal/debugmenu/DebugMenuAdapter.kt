package com.trendyol.android.devtools.internal.debugmenu
...
import com.trendyol.android.devtools.databinding.DevToolsItemDebugMenuBinding

class DebugMenuAdapter constructor() : ListAdapter<DebugActionItem, DebugMenuAdapter.DebugMenuItemViewHolder>(
    AsyncDifferConfig
        .Builder(
    ...
    inner class DebugMenuItemViewHolder constructor(
        val binding: DevToolsItemDebugMenuBinding
