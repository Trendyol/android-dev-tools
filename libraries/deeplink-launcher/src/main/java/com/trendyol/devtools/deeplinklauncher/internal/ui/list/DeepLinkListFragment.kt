...
import com.trendyol.devtools.deeplinklauncher.internal.di.DeepLinkLauncherKoinComponent
...
class DeepLinkListFragment :
    Fragment(R.layout.deeplink_launcher_fragment_deeplink_list),
    DeepLinkLauncherKoinComponent {
    ...
    private val viewModel: DeepLinkListViewModel by viewModel()
