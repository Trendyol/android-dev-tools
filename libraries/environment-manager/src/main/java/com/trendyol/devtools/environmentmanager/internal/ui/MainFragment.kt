...
import com.trendyol.devtools.environmentmanager.internal.di.EnvironmentManagerKoinComponent
...
internal class MainFragment :
    Fragment(R.layout.dev_tools_fragment_main),
    EnvironmentManagerKoinComponent {
